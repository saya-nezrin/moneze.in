...
function WelcomeQuestionnaire({ onClose, onConsultation }) {
  ...
  const contactValid = /\S+@\S+\.\S+/.test(details.email) && /^\d{10}$/.test(details.phone);
  const sendOtp = async () => {

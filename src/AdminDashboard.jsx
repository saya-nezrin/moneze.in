...
export default function AdminDashboard() {
  ...
  const exportCsv = () => {
    const header = ["Name", "Email", "Mobile number", "Investment range", "Status", "Consultation scheduled", "Created"];
    const rows = filteredLeads.map((lead) => [lead.name, lead.email, getLeadPhone(lead), lead.investment_range, lead.status, lead.consultation_scheduled ? "Yes" : "No", lead.created_at]);
